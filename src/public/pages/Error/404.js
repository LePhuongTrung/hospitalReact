...
function errorPage() {
  return (
    <div className="h-screen w-screen bg-sky-400 border-2">
      <div className=" mt-4 mx-40 rounded-md border-2 bg-white ">
        <img
          className=" mt-20 mx-auto w-100 h-60 rounded-full"
          src="https://www.creativefabrica.com/wp-content/uploads/2019/12/22/404-error-line-art-icon-vector-Graphics-1.jpg"
          alt="Rounded avatar"
        />
        <h1 className="mt-4 text-center font-semibold text-4xl">Not Found!</h1>
